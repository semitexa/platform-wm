    ...
    customElements.define('wm-window-frame', class extends HTMLElement {
        ...
        _render() {
            ...
            this.shadowRoot.innerHTML =
                '<style>' +
                ':host{display:flex;position:absolute;background:#313244;border-radius:8px;box-shadow:0 4px 20px rgba(0,0,0,.3);overflow:hidden;flex-direction:column;min-width:200px;min-height:120px;}' +
                '.titlebar{display:flex;align-items:center;padding:6px 10px;background:#45475a;cursor:move;user-select:none;}' +
